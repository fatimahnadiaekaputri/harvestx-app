...
## **Metodologi SDLC Produk**
### Metodologi yang digunakan:  
Agile (Kanban)

### Alasan pemilihan metodologi:  
Metode Kanban dipilih dalam pengembangan aplikasi HarvestX karena fleksibilitasnya dalam menangani proyek berbasis AI dan analisis data. Dalam prediksi harga hasil pertanian, perubahan tren dan data yang dinamis memerlukan sistem yang dapat beradaptasi cepat tanpa batasan iterasi seperti Scrum. Dengan Kanban Board, tim dapat memvisualisasikan alur kerja secara real-time, mengelola tugas secara efisien, serta menghindari bottleneck dalam pengembangan fitur seperti model prediksi harga, notifikasi tren, dan simulasi belanja.

Selain itu, Kanban mendukung kolaborasi lintas tim dan memungkinkan continuous delivery, sehingga pembaruan model AI dapat dilakukan tanpa menunggu siklus sprint tertentu. Keunggulan lain metode Kanban adalah mendukung fleksibilitas tinggi dalam eksperimen dan perubahan prioritas dan memastikan transparansi dan kolaborasi yang lebih baik antar tim sehingga cocok untuk proyek ini yang bersifat highly dynamic, membutuhkan adaptasi cepat, dan memiliki alur kerja yang tidak selalu linier.


### **Tujuan**
Aplikasi HarvestX hadir sebagai solusi inovatif untuk mengatasi permasalahan tersebut dengan menggabungkan analisis data dan kecerdasan buatan. Dengan menyediakan informasi harga pangan, data historis, serta prediksi harga berbasis AI, HarvestX bertujuan untuk membantu masyarakat dalam perencanaan keuangan, mendukung pedagang dalam strategi bisnis, serta memberikan wawasan yang lebih baik bagi peneliti dan pengambil kebijakan. Selain itu, aplikasi ini juga memungkinkan pengguna untuk melakukan simulasi belanja, di mana mereka dapat membandingkan harga pangan saat ini dengan harga prediksi di masa mendatang. Dengan fitur ini, pengguna dapat merancang strategi belanja yang lebih hemat dan efisien.

### **Pengguna potensial dari produk dan kebutuhan para pengguna tersebut** 
1. Konsumen rumah tangga  
Dengan HarvestX, masyarakat umum dapat memantau harga pangan saat ini, melihat data historis, dan melihat prediksi harga, untuk menentukan waktu terbaik dalam berbelanja. Hal ini juga dipermudah dengan adanya fitur simulasi belanja.

2. Pedagang pangan  
HarvestX memiliki fitur pantau dan prediksi harga pangan, sehingga para pedagang dapat memutuskan kapan harus membeli stok barang dan harga jual yang ideal. HarvestX membantu pedagang mengoptimalkan strategi bisnis mereka.
...
### **Gantt-Chart**
![Foto gantt-chart](https://github.com/user-attachments/assets/3b1a9b8f-7082-4f29-905e-bcbb041bdda4)
